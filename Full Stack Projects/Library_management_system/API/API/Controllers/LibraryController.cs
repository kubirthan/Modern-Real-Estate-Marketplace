...
namespace API.Controllers
{
    ...
    public class LibraryController : ControllerBase
    {
        ...
        public ActionResult Register(User user)
        {
            ...
            EmailService.SenEmail(user.Email, subject, body);
        ...
        public ActionResult ApproveRequest(int userId)
        {
            ...
            if (user is not null)
            {
                if (user.AccountStatus == AccountStatus.UNAPROOVED)
                {
                    ...
                    EmailService.SenEmail(user.Email, "Account Approved", $"""
                        <html>
                            <body>
        ...
        public ActionResult SendEmailForPendingReturns()
        {
            ...
            firstFineEmails.ForEach(x =>
            {
                ...
                EmailService.SenEmail(x.User!.Email, "Return Overdue", body);
            });
            ...
            regularFineEmails.ForEach(x =>
            {
                ...
                EmailService.SenEmail(x.User?.Email!, "Fine To Pay", regularFineEmailsBody);
            });
            ...
            overdueFineEmails.ForEach(x =>
            {
                ...
                EmailService.SenEmail(x.User?.Email!, "Fine Overdue", overdueFineEmailsBody);
            });
